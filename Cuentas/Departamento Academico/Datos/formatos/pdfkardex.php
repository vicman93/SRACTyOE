...
$pdf -> SetXY('28.3', '240');
$pdf->Cell(55, 20, utf8_decode('Areá'), 1,0,'C');
$pdf->Cell(115, 20, utf8_decode('Responsable de Areá'), 1,0,'C');
$pdf->Cell(80, 20, utf8_decode('Tipo de Actividad'), 1,0,'C');
$pdf->Cell(120, 20, utf8_decode('Nombre de la actividad'), 1,0,'C');
$pdf->Cell(75, 20, utf8_decode('Ponente'), 1,0,'C');
$pdf->Cell(75, 20, 'Fecha Realizada', 1,0,'C');
...
//Table with N rows and 17 columns
$pdf->SetWidths(array(55,115,80,120,75,75,30));
$consulta = mysql_query("select  area, nombrec, tipoact, nombact, ponente, fecha, totalh from kardex where idalumno='$id_alumnos '");


   while ($reg = mysql_fetch_array($consulta)) {
$pdf->SetFont('Arial','',8);
$pdf->Row(array(
 $reg['area'], $reg['nombrec'], 
$reg['tipoact'], $reg['nombact'], $reg['ponente'],
 $reg['fecha'], $reg['totalh'],
 ));
